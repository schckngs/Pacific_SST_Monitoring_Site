...
### Annual mean anomaly SST trend

The mean annual SST anomaly of the NEP, beginning in 1982, is below. The trendline was calculated using a linear least-squares model.
...
*There are no climatologies for `C46303 South Georgia Strait` and `C46304 Entrance English Bay` as they were installed in 2019.*
...
::: {layout-ncol="2"}
![](./figures/Daily_mean_SSTP_2026_C46183.png)
...
![](./figures/Daily_mean_SSTP_2026_C46147.png)
